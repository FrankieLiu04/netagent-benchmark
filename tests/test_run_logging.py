# EN: Run logging tests for trace serialization and redaction.
# CN: 测试 run logging 的 trace 序列化和脱敏。
...
def _trace_payload(run_id: str) -> dict:
    return {
        "run_id": run_id,
...
def test_run_log_stores_step_trace(tmp_path):
    ...
    path = write_run_log(run_log, _trace_payload(run_log.run_id))
